  ...
  return (
    <>
      <footer className="site-footer">
        ...
        <div className="footer-contact"><strong>Contacts</strong><a className="footer-phone" href="tel:+353871133528">087 113 3528</a><a className="footer-email" href="mailto:daaskbuild@gmail.com">daaskbuild@gmail.com</a><p>The Mall<br />Ballyshannon<br />Co. Donegal</p><div className="footer-social"><small>Social</small><a href="https://www.facebook.com/share/19VhjqBsRv/?mibextid=wwXIfr" target="_blank" rel="noreferrer">Facebook</a><a href="https://www.instagram.com/daaskbuildltd?igsh=aThoeHd6bWJtNGU2&igsi=aThoeHd6bWJtNGU2" target="_blank" rel="noreferrer">Instagram</a><a href="https://www.linkedin.com/in/dermott-mulligan-b8574795" target="_blank" rel="noreferrer">LinkedIn</a></div></div>
